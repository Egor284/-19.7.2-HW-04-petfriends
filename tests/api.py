...
class PetFriends:
    ...
    def Add_photo_of_pet(self, auth_key,pet_id: str,pet_photo: str) -> json:
        """Метод отправляет (постит) на сервер данные о добавлении фото к питомцу и возвращает статус
